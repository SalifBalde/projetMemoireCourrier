...
var DetailExpeditionEcomComponent = /** @class */ (function () {
    function DetailExpeditionEcomComponent(expeditionEcomService, pdfService, fb, router, route, cn23Service) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.cn23Service.createPDF()];
                    case 1:
                        _a.sent(); // Appel de la méthode createPDF
