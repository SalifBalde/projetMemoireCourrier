...
@Component({
  selector: 'app-fermeture-courrier-bureau-liv',
  templateUrl: './fermeture-courrier-bureau-liv.component.html',
  styleUrl: './fermeture-courrier-bureau-liv.component.scss',
    providers: [MessageService],

})
export class FermetureCourrierBureauLivComponent implements  OnInit{
    ...
    showDetails(fermeture: any): void {
        ...
        this.router.navigate(['arriere/reception-import/receptionCourrierBureau/'+id1]);  // Passe l'ID de la fermeture dans l'URL
