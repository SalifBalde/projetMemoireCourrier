...
@Component({
  selector: 'app-fermeture-packet-import',
  templateUrl: './fermeture-packet-import.component.html',
  styleUrl: './fermeture-packet-import.component.scss',
    providers: [MessageService],

})
export class FermeturePacketImportComponent implements OnInit{
    ...
    showDetails(fermeture: any): void {
        ...
        this.router.navigate(['arriere/reception-import/receptionPacketImport/'+id1]);  // Passe l'ID de la fermeture dans l'URL
