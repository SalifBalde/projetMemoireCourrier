...
@Component({
  ...
  templateUrl: './reception-courrier-bureau.component.html',
  styleUrl: './reception-courrier-bureau.component.scss',
      providers: [MessageService],
})
export class ReceptionCourrierBureauComponent implements  OnInit{
