...
@Component({
  selector: 'app-fermeture-colis-bureau-liv',
  templateUrl: './fermeture-colis-bureau-liv.component.html',
  styleUrl: './fermeture-colis-bureau-liv.component.scss',
    providers: [MessageService],

})
export class FermetureColisBureauLivComponent implements OnInit{
    ...
    showDetails(fermeture: any): void {
        ...
        this.router.navigate(['arriere/reception-import/receptionColisBureau/'+id1]);  // Passe l'ID de la fermeture dans l'URL
