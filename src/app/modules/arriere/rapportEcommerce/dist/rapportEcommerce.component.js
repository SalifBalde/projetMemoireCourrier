...
exports.RapportEcommerceComponent = void 0;
...
var RapportEcommerceComponent = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.isLoggedIn = _c.sent();
                        if (!this.isLoggedIn) return [3 /*break*/, 3];
                        _b = this;
                        return [4 /*yield*/, this.keycloak.loadUserProfile()];
                    case 2:
                        _b.userProfile = _c.sent();
    ...
    RapportEcommerceComponent.prototype.buildForm = function () {
        this.form = this.fb.group({
            dateDebut: [undefined, forms_1.Validators.required],
            dateFin: [undefined, forms_1.Validators.required],
            prenom: [undefined, forms_1.Validators.required],
    ...
    __decorate([
        core_1.ViewChild('dt')
    ], RapportEcommerceComponent.prototype, "dt");
    RapportEcommerceComponent = __decorate([
        core_1.Component({
            selector: 'app-rapportEcommerce',
            templateUrl: './rapportEcommerce.component.html',
            providers: [api_1.MessageService]
        })
    ], RapportEcommerceComponent);
    return RapportEcommerceComponent;
}());
exports.RapportEcommerceComponent = RapportEcommerceComponent;
