...
@Component({
  selector: 'app-expedition-colis-import',
  templateUrl: './expedition-colis-import.component.html',
  styleUrl: './expedition-colis-import.component.scss',
      providers: [MessageService],

})
export class ExpeditionColisImportComponent implements  OnInit{
    form: FormGroup;
    isModalOpen = false;
    montant = 0;
    //colis$: ColisDto[] = [];
    ...
    getAllSatutCourrier(){
        this.statutCourrierService.findAll().subscribe((data)=>{
            ...
            this.idStatutFermetureCourrier =this.statutCourrier = data.filter(statut => statut.id === 24);
