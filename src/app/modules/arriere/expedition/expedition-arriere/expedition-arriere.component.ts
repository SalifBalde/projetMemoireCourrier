...
@Component({
  selector: 'app-expedition-arriere',
  templateUrl: './expedition-arriere.component.html',
  styleUrl: './expedition-arriere.component.scss',
    providers: [MessageService],

})
export class ExpeditionArriereComponent  implements  OnInit{
    ...
    openDialog1(courrier: CourrierDto) {
        ...
        console.log(this.selectedStructure.code+this.numeroDepech+this.currentYearLastTwoDigits)
