...
@Component({
  selector: 'app-expedition-lettre',

  templateUrl: './expedition-lettre.component.html',
  styleUrl: './expedition-lettre.component.scss',
    providers: [MessageService],

})
export class ExpeditionLettreComponent  implements  OnInit{
    form: FormGroup;
    isModalOpen = false;
    montant = 0;
    //colis$: ColisDto[] = [];
