...
@Component({
  selector: 'app-expedition-packet-import',
  templateUrl: './expedition-packet-import.component.html',
  styleUrl: './expedition-packet-import.component.scss',
      providers: [MessageService],
})
export class ExpeditionPacketImportComponent implements  OnInit{
    form: FormGroup;
    isModalOpen = false;
    montant = 0;
    //colis$: ColisDto[] = [];
