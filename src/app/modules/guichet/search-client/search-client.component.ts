            ...
            this.clientService
                ...
                .subscribe(
                    () => {
                        ...
                        if (this.id == "1")
                            this.router.navigateByUrl('/guichet/courrier-ordinaire/' + this.client.id + '/' + this.client.nom + ' ' + this.client.prenom + '/' + this.client.telephone);
                        else if(this.id == "2")
                            this.router.navigateByUrl('/guichet/courrier-recommandé/' + this.client.id + '/' + this.client.nom + ' ' + this.client.prenom + '/' + this.client.telephone);
                        else if(this.id == "3")
                            this.router.navigateByUrl('/guichet/courrier-valeur-declare/' + this.client.id + '/' + this.client.nom + ' ' + this.client.prenom + '/' + this.client.telephone);
                        else
                            this.router.navigateByUrl('/guichet/courrier-ordinaire/' + this.client.id + '/' + this.client.nom + ' ' + this.client.prenom + '/' + this.client.telephone);
