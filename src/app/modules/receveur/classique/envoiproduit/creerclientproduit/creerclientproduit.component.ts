...
@Component({
    ...
    templateUrl: './creerclientproduit.component.html',
})
export class CreerClientProduitComponent implements OnInit {
    form: FormGroup;
        ...
        if (this.form.valid) {
            ...
            this.clientService.save(clientData).subscribe(
                ...
                (error) => {
                    ...
                    this.messageService.add({ severity: 'error', summary: 'Erreur', detail: 'Erreur lors de l\'enregistrement du client.' });
                }
            );
        }
    }
    ...
    creerEnvoi(): void {
        ...
        this.router.navigate(['/receveur/Creerenvoiproduit'], { state: { clientData: this.clientData } });
    }
