...
var CourrierDetailsComponent = /** @class */ (function () {
    function CourrierDetailsComponent(courrierService, factureService, pdfService, cn23AService, fb, router, route) {
    ...
    CourrierDetailsComponent = __decorate([
        core_1.Component({
            selector: 'app-courrier-details',
            templateUrl: './courrier-details.component.html'
        })
    ], CourrierDetailsComponent);
    return CourrierDetailsComponent;
}());
exports.CourrierDetailsComponent = CourrierDetailsComponent;
