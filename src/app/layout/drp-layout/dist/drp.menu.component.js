...
exports.DrpMenuComponent = void 0;
var core_1 = require("@angular/core");
var DrpMenuComponent = /** @class */ (function () {
    function DrpMenuComponent(layoutService) {
    ...
    DrpMenuComponent = __decorate([
        core_1.Component({
            selector: 'drp-menu',
            templateUrl: './drp.menu.component.html'
        })
    ], DrpMenuComponent);
    return DrpMenuComponent;
}());
exports.DrpMenuComponent = DrpMenuComponent;
