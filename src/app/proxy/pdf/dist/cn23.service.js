...
var Cn23Service = /** @class */ (function () {
    ...
    Cn23Service.prototype._base64ToArrayBuffer = function (base64) {
    ...
    Cn23Service.prototype.ngOnInit = function () {
        var doc = new jspdf_1["default"]({ format: 'a4', orientation: 'l' });
        ...
        doc.text('(Apposer les étiquettes officielles le cas échéant)', pageWidth / 2, 77, {
            align: 'left'
        });
        ...
        doc.text('Je certifie que cette envoie ne contient   ', pageWidth / 2, 180, {
            align: 'left'
        });
        ...
        //
        doc.text("Nom et Adresse, Colis Postal et Téléphone de l'expecteur", pageWidth / 3, 15, {
            align: 'right'
        });
        doc.setFontSize(9);
        ...
        doc.text('Nom et Adresse,Colis Postal et le Téléphone du destinataire y compis', pageHeight / 13, 50, {
            align: 'left'
        });
        ...
        doc.text('123 GREY ST EAST MELBOURNE VICTORIA 300S AUSTRALIA', pageHeight / 13, 68, {
            align: 'left'
        });
        ...
        doc.text("Instruction de l'expéditeur en cas de non-livraison ", pageHeight / 13, 160, {
            align: 'left'
        });
        doc.text("Renvoyer à l'expéditeur ", pageHeight / 13, 170, {
            align: 'left'
        });
        doc.text('Remarque:Pour tenir compte des besoins de leur service, les Administrations ont la latitude d utiliser cette formule unique,soit comme partie de la formule-Liasse CP72 ', pageHeight / 29, 209, {
            align: 'left'
        });
        ...
        // generate
        var pdf = doc.output('datauristring', { filename: 'RAB' });
        var uri = pdf.split(',')[1];
        console.log(uri);
